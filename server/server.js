...
serveur.startServer = function () {
    ...
    function websocketStart() {
        ...
        var bot1 = game.createCharacter("Manuel Valse", 1, "IA", "h", "Zonmai");
        var bot2 = game.createCharacter("Florence Parly2", 2, "IA", "f", "Zonmai");
        var bot3 = game.createCharacter("Charles Padqua", 3, "IA", "nb", "Zonmai");
